...
def get_paths():
    ...
    paths = {
        ...
        "results_path": {
            "unsmoothed": os.path.join(base_path, "results_test_normalization", "unsmoothed"),
            "normalized": os.path.join(base_path, "results_test_normalization", "normalized"),
            "unormalized": os.path.join(base_path, "results_test_normalization", "unormalized"),
            "normalized_time": os.path.join(base_path, "results_test_normalization", "normalized_time")
        },
