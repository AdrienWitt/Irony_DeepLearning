...
r_text_audio = np.load("results_wholebrain/normalized_time/correlation_map_flat_audio_opensmile_text_weighted_base_5.npy")
r_text = np.load("results_wholebrain/normalized_time/correlation_map_flat_text_weighted_base_5.npy")
r_audio = np.load("results_wholebrain/normalized_time/correlation_map_flat_audio_opensmile_base_5.npy")
...
df.to_excel('results_wholebrain/results_maps/cluster_stats_table.xlsx', index=False)
...
nib.save(all_clusters_img, "results_wholebrain/results_maps/all_clusters_map.nii")
print("\nSaved all clusters in a single NIfTI file with delta_r values: results_wholebrain/results_maps/all_clusters_map.nii")
...
for i, cluster in enumerate(cluster_stats_sorted[:5], 1):
    ...
    nib.save(cluster_img, f"results_wholebrain/results_maps/top_cluster_{i}.nii")
